...
<!-- sort -->
        <div>
            ...
            <select id="sortAbjad" wire:model.live="selected_abjad"
                class="block w-44 p-2 text-sm border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500">
